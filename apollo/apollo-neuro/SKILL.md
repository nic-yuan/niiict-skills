...
**来源：** memfree（Hybrid AI Search Engine，GitHub 1.5k stars）的auto-decision机制
**借鉴内容：** "Automatically determines when to perform internet searches" — 自动判断该用哪个知识源
**融入方式：** 作为直觉路径的子机制，不改变现有四路径架构
